...
class QSAMPreBasicBlock(nn.Module):
    """
    ...
    def __init__(
        ...
        """
        super(QSAMPreBasicBlock, self).__init__()
...
class QSAMPreResNet(nn.Module):
    """
    define QSAMPreResNet on small data sets
    """
    ...
    def __init__(
        ...
        """
        super(QSAMPreResNet, self).__init__()
